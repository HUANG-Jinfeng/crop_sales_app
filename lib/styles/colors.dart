...
class AppColors {
  ...
  /// 主文本灰色
  static const Color primaryGreyText1 = Color(0xFF79CDCD);

  /// tabBar 默认颜色 灰色
  static const Color tabBarElement = Color(0xFFAEEEEE);

  /// tabBar 激活颜色
  static const Color tabBarActive = Color(0xFF66CDAA);

  /// 分类tab渐变色
  static Color buttonLine1 = Color(0xFF20B2AA);//BA68C8

  /// 分类tab渐变色
  static const Color buttonLine2 = Color(0xFF7265E3);

  /// 主题色
  static const Color primaryColor = Color(0xFF008B8B);//8B63E6

  static const Color primaryColorAccent = Color(0xFFAEEEEE);
  ...
  static const Color supplierColor2 = Color(0xFF008B8B);
}
