...
import 'package:crop_sales_app/screen/Registration/registration_page_buyer.dart';
...
//import 'package:crop_sales_app/screen/login/components/login_model.dart';
...
class BuyerLoginPage extends StatefulWidget {
  ...
  @override
  _BuyerLoginFormState createState() => _BuyerLoginFormState();
}

class _BuyerLoginFormState extends State<BuyerLoginPage> {
      ...
      if (email != null && password != null) {
        ...
        if ((_formKey.currentState as FormState).validate()) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (BuildContext context) => BuyerMainPage(),
            ),
          );
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (BuildContext context) => BuyerRegisterPage(),
          ),
        );
      }
    } catch (e) {
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          Image(
                            image: AssetImage("assets/images/login/login_buyer.png"),
                            width: 150,
                            height: 150,
                            fit: BoxFit.fill,
                          ),
