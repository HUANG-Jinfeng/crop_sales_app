...
import 'components/registration_model_seller.dart';
...
class _SellerRegisterPageState extends State<SellerRegisterPage> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<SellerRegisterModel>(
      create: (_) => SellerRegisterModel(),
      child: Scaffold(
        ...
        body: Center(
          child: SingleChildScrollView(
            ...
            child: Consumer<SellerRegisterModel>(builder: (context, model, child) {
              return Stack(
                children: [
                  Padding(
